...
function wallpapersddm() {
    ...
    cp $1 /usr/share/sddm/themes/sddm-eucalyptus-drop/Backgrounds/background
    echo "SDDM background set to $1"
}
...
if [ -s "$HOME/.nvm/nvm.sh" ] && [ ! "$(type __init_nvm)" = function ]; then
  ...
  declare -a __node_commands=('nvim' 'nvm' 'node' 'npm' 'yarn' 'gulp' 'grunt' 'webpack')
  function __init_nvm() {
